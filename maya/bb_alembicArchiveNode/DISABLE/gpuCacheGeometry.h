...
protected:
    ...
    friend boost::shared_ptr<ShapeData>
    boost::make_shared<ShapeData>();
...
private:
    ...
    friend boost::shared_ptr<XformData>
    boost::make_shared<XformData>();
...
#else
	template <class T, class A1, class A2>
	friend boost::shared_ptr<T> boost::make_shared(const A1& a1, const A2& a2);
#endif
