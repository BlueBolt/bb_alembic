...
public:
    ...
    boost::shared_ptr<Array<index_type> >& triangleIndices()
    { return fTriangleIndices; }

    boost::shared_ptr<Array<index_type> >& wireIndices()
    { return fWireIndices; }

    boost::shared_ptr<Array<float> >& positions()
    { return fPositions; }

    boost::shared_ptr<Array<float> >& normals()
    { return fNormals; }
...
private:
    ...
    // Output
    boost::shared_ptr<Array<index_type> > fTriangleIndices;
    boost::shared_ptr<Array<index_type> > fWireIndices;
