...
namespace MaterialBakers {
    ...
    public:
        ...
        static BaseMaterialNodeBaker::Ptr create(const MObject& node);
            ...
            if (!plug.isNull() && prop) {
                ...
                if (plug.isDestination()) {
                    ...
                    if (plugArray.length() > 0) {
                        ...
                        srcBaker = BaseMaterialNodeBaker::create(srcNode);
                        if (srcBaker) {
    ...
    BaseMaterialNodeBaker::Ptr BaseMaterialNodeBaker::create(const MObject& node)
    {
...
public:
    ...
    {
        fRootBaker = BaseMaterialNodeBaker::create(node);
    }
