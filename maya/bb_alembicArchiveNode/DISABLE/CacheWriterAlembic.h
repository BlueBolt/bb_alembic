...
#else
    friend boost::shared_ptr<AlembicCacheWriter> boost::make_shared<AlembicCacheWriter>(
        const MFileObject& file, const char& compressLevel, const MString& dataFormat);
#endif
